...
import { recupererListeAutos, recupererListeCarrosseriesAutos, recupererListeEnergiesAutos, recupererListeFamillesAutos, recupererListeMarquesAutos, recupererListeMotorisationsAutos, recupererListeNbPortesAutos, recupererListeTransmissionsAutos } from "./__gen/referentiel-modeles-vehicules/autos"
...
const mocked = <TResolve>(
	method: "get" | "post" | "put",
	mask: Mask,
	respond: TResolve,
	_blueprint: (params: any) => Promise<AxiosResponse<TResolve>>,
): RestHandler<MockedRequest<TResolve>> =>
	rest[method](mask, (req, res, ctx) =>
		res(ctx.delay(1000), ctx.status(200, "Mocked status"), ctx.json(respond)),
	)

const mockedGet = <TResolve>(
	mask: Mask,
	respond: TResolve,
	_blueprint: (params: any) => Promise<AxiosResponse<TResolve>>,
): RestHandler<MockedRequest<TResolve>> =>
...
const getIardReferentielVehiculesAutosMocks = () => [
	...
	mockedGet(
		...
		[
			{ codeEnergie: "2", libelleEnergie: "Diesel" },
			{ codeEnergie: "1", libelleEnergie: "Essence" },
			{ codeEnergie: "4", libelleEnergie: "Electricité" },
			{ codeEnergie: "5", libelleEnergie: "Hybride essence" },
			{ codeEnergie: "3", libelleEnergie: "G.P.L." },
			{ codeEnergie: "7", libelleEnergie: "E85 / Super éthanol" },
		],
	...
	mockedGet(
		...
		[
			{ codeFamille: "2554", libelleFamille: "MEGANE" },
			{ codeFamille: "2553", libelleFamille: "MASTER" },
			{
				codeFamille: "2587",
				libelleFamille: "TRAFIC",
			},
			{ codeFamille: "2535", libelleFamille: "CLIO" },
			{ codeFamille: "100000007829", libelleFamille: "CAPTUR" },
			{
				codeFamille: "2595",
			...
			{ codeFamille: "2539", libelleFamille: "ESPACE" },
			{ codeFamille: "100000031417", libelleFamille: "ALASKAN" },
			{
				codeFamille: "2537",
				libelleFamille: "DIVERS",
			},
			{ codeFamille: "2586", libelleFamille: "THALIA" },
			{ codeFamille: "100000000887", libelleFamille: "MAXITY" },
			{
				codeFamille: "2592",
	...
	mockedGet(
		...
		[
			{ codeCarrosserie: "01", libelleCarrosserie: "Berline" },
			{ codeCarrosserie: "20", libelleCarrosserie: "Utilitaire" },
			{ codeCarrosserie: "11", libelleCarrosserie: "SUV" },
			{ codeCarrosserie: "10", libelleCarrosserie: "Monospace compact" },
			{ codeCarrosserie: "03", libelleCarrosserie: "Break" },
			{ codeCarrosserie: "14", libelleCarrosserie: "Minibus-combi" },
			{ codeCarrosserie: "07", libelleCarrosserie: "Monospace" },
			{ codeCarrosserie: "08", libelleCarrosserie: "Ludospace" },
			{ codeCarrosserie: "12", libelleCarrosserie: "Pick-up" },
			{ codeCarrosserie: "04", libelleCarrosserie: "Commerciale" },
		],
	...
	mockedGet(
		...
		[
			{ libelleMotorisation: "1.3 TCE 140 CH" },
			{ libelleMotorisation: "1.5 BLUE DCI 115 CH" },
			{ libelleMotorisation: "1.3 TCE 160 CH" },
			{ libelleMotorisation: "1.7 BLUE DCI 150 CH" },
			{ libelleMotorisation: "2.0 DCI 170 CH" },
			{ libelleMotorisation: "2.0 DCI 145 CH" },
			{ libelleMotorisation: "1.7 BLUE DCI 120 CH" },
			{ libelleMotorisation: "1.3 TCE 115 CH" },
			{ libelleMotorisation: "2.3 DCI 180 CH" },
			{ libelleMotorisation: "1.5 BLUEDCI 115 CH" },
			{ libelleMotorisation: "1.0 TCE 100 CH" },
			{ libelleMotorisation: "2.3 DCI 170 CH" },
			{ libelleMotorisation: "1.3 TCE 130 CH" },
			{ libelleMotorisation: "2.3 DCI 135 CH" },
			{ libelleMotorisation: "1.0 TCE 90 CH" },
			{ libelleMotorisation: "1.5 BLUE DCI 95 CH" },
			{ libelleMotorisation: "1.0 SCE 65 CH" },
			{ libelleMotorisation: "2.3 DCI 150 CH" },
			{ libelleMotorisation: "1.7 BLUEDCI 150 CH" },
			{ libelleMotorisation: "Z.E R110" },
			{ libelleMotorisation: "1.8 TCE 225 CH" },
			{ libelleMotorisation: "2.0 BLUE DCI 200 CH" },
			{ libelleMotorisation: "0.9 TCE 95 CH" },
			{ libelleMotorisation: "1.6 DCI 95 CH" },
			{ libelleMotorisation: "2.0 BLUE DCI 160 CH" },
			{ libelleMotorisation: "1.0 SCE 75 CH" },
			{ libelleMotorisation: "2.0 DCI 120 CH" },
			{ libelleMotorisation: "Z.E R135" },
			{ libelleMotorisation: "1.3 TCE 150 CH" },
			{ libelleMotorisation: "1.6 DCI 145 CH" },
			{ libelleMotorisation: "1.8 TCE 300 CH" },
			{ libelleMotorisation: "2.3 DCI 165 CH" },
			{ libelleMotorisation: "E-TECH 140 CH" },
			{ libelleMotorisation: "E-TECH PLUG-IN 160 CH" },
			{ libelleMotorisation: "1.0 TCE GPL 100 CH" },
			{ libelleMotorisation: "0.9 TCE 90 CH" },
			{ libelleMotorisation: "1.6 DCI 125 CH" },
			{ libelleMotorisation: "2.0 BLUEDCI 160 CH" },
			{ libelleMotorisation: "2.0 BLUEDCI 190 CH" },
			{ libelleMotorisation: "1.5 BLUE DCI 80 CH" },
			{ libelleMotorisation: "2.3 DCI 130 CH" },
			{ libelleMotorisation: "2.3 DCI 145 CH" },
			{ libelleMotorisation: "1.5 BLUEDCI 85 CH" },
			{ libelleMotorisation: "1.5 BLUEDCI 95 CH" },
			{ libelleMotorisation: "1.6 DCI 120 CH" },
			{ libelleMotorisation: "2.0 DCI 190 CH" },
			{ libelleMotorisation: "ESSENCE" },
			{ libelleMotorisation: "Z.E 60 CH" },
			{ libelleMotorisation: "Z.E ELECTRIQUE 81 CH" },
			{ libelleMotorisation: "1.5 DCI 90 CH" },
			{ libelleMotorisation: "1.8 TCE 280 CH" },
			{ libelleMotorisation: "Z.E R90" },
			{ libelleMotorisation: "0.9 TCE 75 CH" },
			{ libelleMotorisation: "1.3 TCE 155 CH" },
			{ libelleMotorisation: "1.3 TCE GPL 140 CH" },
			{ libelleMotorisation: "2.0 DCI 160 CH" },
			{ libelleMotorisation: "0.9 TCE E85 90 CH" },
			{ libelleMotorisation: "1.0 TCE E85 100 CH" },
			{ libelleMotorisation: "1.2 16V 75 CH" },
			{ libelleMotorisation: "1.2 TCE GPL 130 CH" },
			{ libelleMotorisation: "1.3 TCE E85 140 CH" },
			{ libelleMotorisation: "1.3 TCE E85 150 CH" },
			{ libelleMotorisation: "1.3 TCE GPL 130 CH" },
			{ libelleMotorisation: "1.5 BLUEHDI 85 CH" },
			{ libelleMotorisation: "1.5 DCI 70 CH" },
			{ libelleMotorisation: "1.6 105 CH" },
			{ libelleMotorisation: "1.6 SCE 115 CH" },
			{ libelleMotorisation: "1.6 SCE GPL 115 CH" },
			{ libelleMotorisation: "1.7 DCI 150 CH" },
			{ libelleMotorisation: "2.0 150 CH" },
			{ libelleMotorisation: "2.1 65 CH" },
			{ libelleMotorisation: "2.5 DXI 120 CH" },
			{ libelleMotorisation: "2.5 DXI 140 CH" },
			{ libelleMotorisation: "3.0 DXI 130 CH" },
			{ libelleMotorisation: "Z.E." },
		],
	...
	mockedGet(
		...
		[
			...
			{
				codeTransmission: "4",
				libelleTransmission: "Boîte manuelle/intégrale",
			},
			{
				codeTransmission: "6",
				libelleTransmission: "Boîte robotisée/intégrale",
			},
			{
				codeTransmission: "5",
				libelleTransmission: "Boîte automatique/intégrale",
			},
		],
...
const getIardReferentielVehiculesMocks = () => [
	mockedGet(
	...
	mockedGet(
		"*/vehicules/:numeroRepertoire",
		{
			...
			denominationCommercialeCourte:
				"MEGANE IV ESTATE 1.5 BLUE DCI 115 CH INTENS EDC",
			...
			champRecherche:
				"RENAULT MEGANE MEGANE IV 4 ESTATE MEGANE IV 4 ESTATE 1.5 1,5 BLUE DCI 601 115 CH INTENS EDC Diesel Boîte robotisée Break",
			codeGenre: "01",
		...
		recupererVehiculeParNumeroRepertoire,
	),
]
...
const getIardDevisVehiculesNomenclaturesMocks = () => [
	...
	mockedGet(
		"*/types_permis/vehicule/:numeroRepertoire",
		{
			...
			detailNomenclature: [{ code: "B", libelle: "4 roues assujettis (B,BE)" }],
		},
...
const handlers = [
	...
	...getIardDevisVehiculesNomenclaturesMocks(), // ...getVehiculesMSW(),
	// ...getMotosQuadsMSW(),
]
