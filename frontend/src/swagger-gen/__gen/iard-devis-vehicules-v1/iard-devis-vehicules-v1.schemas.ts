...
export type RecupererDatesAntecedentsSinistraliteParams = { dateDEcheanceAncienAssureur: string };

export type SolutionsEligiblesGetParams = { idRisqueVehiculeConducteurAAssurer: number; filtre?: SolutionsEligiblesGetFiltre };
