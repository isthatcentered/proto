...
import type { InfoSraVehPost, InfoSraVehPut, RecupererListeSRAParams, Sra, SraPagination } from "./referentiel-modeles-vehicules.schemas"
...
export const getRecupererListeSRAQueryKey = (
	params?: RecupererListeSRAParams,
) => [`/modeles/sra`, ...(params ? [params] : [])]
...
>(
	params?: RecupererListeSRAParams,
	options?: {
		query?: UseQueryOptions<AsyncReturnType<typeof recupererListeSRA>, Error>
	...
	const query = useQuery<AsyncReturnType<typeof recupererListeSRA>, Error>(
		queryKey,
		() => recupererListeSRA<Data>(params, requestOptions),
		queryOptions,
	)
...
>(options?: {
	mutation?: UseMutationOptions<
		AsyncReturnType<typeof creationSRA>,
		Error,
		{ data: InfoSraVehPost },
		unknown
	>
...
>(options?: {
	mutation?: UseMutationOptions<
		AsyncReturnType<typeof modificationSRA>,
		Error,
		{ data: InfoSraVehPut },
		unknown
	>
...
export const getRecupererListeSRAMock = () => ({
	infoPagination: {
		page: faker.datatype.number(),
		totalPages: faker.datatype.number(),
		nombreElements: faker.datatype.number(),
		totalElements: faker.datatype.number(),
		premierePage: faker.datatype.boolean(),
		dernierePage: faker.datatype.boolean(),
		taillePage: faker.datatype.number(),
		triPagination: [...Array(faker.datatype.number({ min: 1, max: 10 }))].map(
			() => ({
				direction: faker.helpers.randomize([faker.random.word(), undefined]),
				property: faker.helpers.randomize([faker.random.word(), undefined]),
				ignoreCase: faker.helpers.randomize([
					faker.datatype.boolean(),
					undefined,
				]),
				nullHandling: faker.helpers.randomize([faker.random.word(), undefined]),
				descending: faker.helpers.randomize([
					faker.datatype.boolean(),
					undefined,
				]),
				ascending: faker.helpers.randomize([
					faker.datatype.boolean(),
					undefined,
				]),
			}),
	...
	sraDemandes: [...Array(faker.datatype.number({ min: 1, max: 10 }))].map(
		() => ({
			codeEtatSraVehicule: faker.random.word(),
			libelleEtatSraVehicule: faker.random.word(),
			codeSra: faker.random.word(),
			numeroRepertoire: faker.helpers.randomize([
				faker.random.word(),
				undefined,
			]),
			dateMiseAJour: faker.random.word(),
		}),
	),
})

export const getCreationSRAMock = () => ({
	codeEtatSraVehicule: faker.random.word(),
	libelleEtatSraVehicule: faker.random.word(),
	codeSra: faker.random.word(),
	numeroRepertoire: faker.helpers.randomize([faker.random.word(), undefined]),
	dateMiseAJour: faker.random.word(),
})

export const getModificationSRAMock = () => ({
	codeEtatSraVehicule: faker.random.word(),
	libelleEtatSraVehicule: faker.random.word(),
	codeSra: faker.random.word(),
	numeroRepertoire: faker.helpers.randomize([faker.random.word(), undefined]),
