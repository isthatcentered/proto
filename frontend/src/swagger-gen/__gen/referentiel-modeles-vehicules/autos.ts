...
export const getRecupererListeAutosQueryKey = (
	params?: RecupererListeAutosParams,
) => [`/vehicules/autos`, ...(params ? [params] : [])]
...
>(
	params?: RecupererListeAutosParams,
	options?: {
		query?: UseQueryOptions<AsyncReturnType<typeof recupererListeAutos>, Error>
	...
	const query = useQuery<AsyncReturnType<typeof recupererListeAutos>, Error>(
		queryKey,
		() => recupererListeAutos<Data>(params, requestOptions),
		queryOptions,
	)
...
export const recupererListeCarrosseriesAutos = <Data = unknown>(
	...
	return customInstance<Data extends unknown ? CarrosserieVehicule[] : Data>(
		{
			url: `/vehicules/autos/carrosseries`,
			method: "get",
			params,
		}, // eslint-disable-next-line
		// @ts-ignore
...
export const getRecupererListeCarrosseriesAutosQueryKey = (
	params?: RecupererListeCarrosseriesAutosParams,
) => [`/vehicules/autos/carrosseries`, ...(params ? [params] : [])]
...
>(
	...
	options?: {
		query?: UseQueryOptions<
			AsyncReturnType<typeof recupererListeCarrosseriesAutos>,
			Error
		>
		request?: SecondParameter<typeof customInstance>
	},
	...
	>(
		queryKey,
		() => recupererListeCarrosseriesAutos<Data>(params, requestOptions),
		queryOptions,
	)
...
export const getRecupererListeEnergiesAutosQueryKey = (
	params?: RecupererListeEnergiesAutosParams,
) => [`/vehicules/autos/energies`, ...(params ? [params] : [])]
...
>(
	...
	options?: {
		query?: UseQueryOptions<
			AsyncReturnType<typeof recupererListeEnergiesAutos>,
			Error
		>
		request?: SecondParameter<typeof customInstance>
	},
	...
	>(
		queryKey,
		() => recupererListeEnergiesAutos<Data>(params, requestOptions),
		queryOptions,
	)
...
export const getRecupererListeFamillesAutosQueryKey = (
	params?: RecupererListeFamillesAutosParams,
) => [`/vehicules/autos/familles`, ...(params ? [params] : [])]
...
>(
	...
	options?: {
		query?: UseQueryOptions<
			AsyncReturnType<typeof recupererListeFamillesAutos>,
			Error
		>
		request?: SecondParameter<typeof customInstance>
	},
	...
	>(
		queryKey,
		() => recupererListeFamillesAutos<Data>(params, requestOptions),
		queryOptions,
	)
...
export const recupererListeGroupesTarifAutos = <Data = unknown>(
	...
	>(
		{
			url: `/vehicules/autos/groupes_tarification`,
			method: "get",
			params,
		}, // eslint-disable-next-line
		// @ts-ignore
...
export const getRecupererListeGroupesTarifAutosQueryKey = (
	params?: RecupererListeGroupesTarifAutosParams,
) => [`/vehicules/autos/groupes_tarification`, ...(params ? [params] : [])]
...
>(
	...
	options?: {
		query?: UseQueryOptions<
			AsyncReturnType<typeof recupererListeGroupesTarifAutos>,
			Error
		>
		request?: SecondParameter<typeof customInstance>
	},
	...
	>(
		queryKey,
		() => recupererListeGroupesTarifAutos<Data>(params, requestOptions),
		queryOptions,
	)
...
export const getRecupererListeMarquesAutosQueryKey = (
	params?: RecupererListeMarquesAutosParams,
) => [`/vehicules/autos/marques`, ...(params ? [params] : [])]
...
>(
	...
	options?: {
		query?: UseQueryOptions<
			AsyncReturnType<typeof recupererListeMarquesAutos>,
			Error
		>
		request?: SecondParameter<typeof customInstance>
	},
	...
	>(
		queryKey,
		() => recupererListeMarquesAutos<Data>(params, requestOptions),
		queryOptions,
	)
...
export const recupererListeMotorisationsAutos = <Data = unknown>(
	...
	return customInstance<Data extends unknown ? MotorisationVehicule[] : Data>(
		{
			url: `/vehicules/autos/motorisations`,
			method: "get",
			params,
		}, // eslint-disable-next-line
		// @ts-ignore
...
export const getRecupererListeMotorisationsAutosQueryKey = (
	params?: RecupererListeMotorisationsAutosParams,
) => [`/vehicules/autos/motorisations`, ...(params ? [params] : [])]
...
>(
	...
	options?: {
		query?: UseQueryOptions<
			AsyncReturnType<typeof recupererListeMotorisationsAutos>,
			Error
		>
		request?: SecondParameter<typeof customInstance>
	},
	...
	>(
		queryKey,
		() => recupererListeMotorisationsAutos<Data>(params, requestOptions),
		queryOptions,
	)
...
export const recupererListeNbPortesAutos = <Data = unknown>(
	...
	return customInstance<Data extends unknown ? NombrePortesVehicule[] : Data>(
		{
			url: `/vehicules/autos/nombres_portes`,
			method: "get",
			params,
		}, // eslint-disable-next-line
		// @ts-ignore
...
export const getRecupererListeNbPortesAutosQueryKey = (
	params?: RecupererListeNbPortesAutosParams,
) => [`/vehicules/autos/nombres_portes`, ...(params ? [params] : [])]
...
>(
	...
	options?: {
		query?: UseQueryOptions<
			AsyncReturnType<typeof recupererListeNbPortesAutos>,
			Error
		>
		request?: SecondParameter<typeof customInstance>
	},
	...
	>(
		queryKey,
		() => recupererListeNbPortesAutos<Data>(params, requestOptions),
		queryOptions,
	)
...
export const recupererListeTransmissionsAutos = <Data = unknown>(
	...
	return customInstance<Data extends unknown ? TransmissionVehicule[] : Data>(
		{
			url: `/vehicules/autos/transmissions`,
			method: "get",
			params,
		}, // eslint-disable-next-line
		// @ts-ignore
...
export const getRecupererListeTransmissionsAutosQueryKey = (
	params?: RecupererListeTransmissionsAutosParams,
) => [`/vehicules/autos/transmissions`, ...(params ? [params] : [])]
...
>(
	...
	options?: {
		query?: UseQueryOptions<
			AsyncReturnType<typeof recupererListeTransmissionsAutos>,
			Error
		>
		request?: SecondParameter<typeof customInstance>
	},
	...
	>(
		queryKey,
		() => recupererListeTransmissionsAutos<Data>(params, requestOptions),
		queryOptions,
	)
