...
import type { GetModleVehiculesByNumeroChassisUsingGETParams, GetNumRepForImmatriculationUsingGETParams, VehiculeAssureDTO } from "./referentiel-modeles-vehicules.schemas"
...
export const getNumRepForImmatriculationUsingGET = <Data = unknown>(
	...
	return customInstance<Data extends unknown ? VehiculeAssureDTO : Data>(
		{
			url: `/v1/modeles/immatriculation`,
			method: "get",
			params,
...
export const getGetNumRepForImmatriculationUsingGETQueryKey = (
	params?: GetNumRepForImmatriculationUsingGETParams,
) => [`/v1/modeles/immatriculation`, ...(params ? [params] : [])]
...
>(
	...
	options?: {
		query?: UseQueryOptions<
			AsyncReturnType<typeof getNumRepForImmatriculationUsingGET>,
			Error
		>
	...
	>(
		queryKey,
		() => getNumRepForImmatriculationUsingGET<Data>(params, requestOptions),
		queryOptions,
	)
...
export const getModleVehiculesByNumeroChassisUsingGET = <Data = unknown>(
	...
	return customInstance<Data extends unknown ? VehiculeAssureDTO : Data>(
		{
			url: `/v1/modeles/numeros_chassis`,
			method: "get",
			params,
		}, // eslint-disable-next-line
		// @ts-ignore
...
export const getGetModleVehiculesByNumeroChassisUsingGETQueryKey = (
	params?: GetModleVehiculesByNumeroChassisUsingGETParams,
) => [`/v1/modeles/numeros_chassis`, ...(params ? [params] : [])]
...
>(
	...
	options?: {
		query?: UseQueryOptions<
			AsyncReturnType<typeof getModleVehiculesByNumeroChassisUsingGET>,
			Error
		>
		request?: SecondParameter<typeof customInstance>
	},
	...
	>(
		queryKey,
		() =>
			getModleVehiculesByNumeroChassisUsingGET<Data>(params, requestOptions),
		queryOptions,
	)
...
export const getGetNumRepForImmatriculationUsingGETMock = () => ({
...
export const getGetModleVehiculesByNumeroChassisUsingGETMock = () => ({
	avertissements: faker.helpers.randomize([
		[...Array(faker.datatype.number({ min: 1, max: 10 }))].map(() => ({
			code: faker.helpers.randomize([faker.random.word(), undefined]),
			message: faker.helpers.randomize([faker.random.word(), undefined]),
