...
const getIardReferentielVehiculesMocks = () => [
	 mockedGet( "*/v1/vehicules/immatriculation", null as any, getNumRepForImmatriculationUsingGET1 ),
	 mockedGet( "*/v1/vehicules/numeros_chassis", null as any, getModleVehiculesByNumeroChassisUsingGET1 ),
	 mockedGet(
