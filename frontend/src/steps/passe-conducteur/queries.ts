...
import {
	...
	useRecupererDatesAntecedentsSinistralite,
} from "../../swagger-gen/__gen/iard-devis-vehicules-v1/acceptation-risque-véhicule"
...
import { useNomenclature, useQuery } from "../../swagger-gen"

export const useDatesAntecedentsSinistralite = (
	dateDEcheanceAncienAssureur: DS.DateString | undefined,
) => {
	...
	return useQuery(useRecupererDatesAntecedentsSinistralite, params, dates => ({
...
export const checkAcceptationProspect = (
	infos: InfoAcceptationProspect,
