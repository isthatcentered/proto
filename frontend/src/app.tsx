...
type UsageVehiculeData = IdentificationVehiculeData &
	StepValues<IdentificationVehiculeStep>

type IdentificationConducteurData = UsageVehiculeData &
	StepValues<UsageVehiculeStep>

type PasseAssureData = IdentificationConducteurData &
	StepValues<IdentificationConducteurStep>
				...
				switch (step.type) {
					case "init-parcours":
						return (
							<InitParcours
								onConfirm={values =>
									setNextStep({ type: "identification-vehicule", data: values })
								}
							/>
						)
						...
						return (
							<UsageVehicule
								anneeMiseEnCirculationVehicule={
									step.data.anneeMiseEnCirculationVehicule
								}
								numeroRepertoire={step.data.numeroRepertoire}
								onConfirm={values =>
									setNextStep({
										type: "identification-conducteur",
										data: { ...step.data, ...values },
									})
								}
							/>
