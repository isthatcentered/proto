...
const GEN_PATH = "./frontend/src/swagger-gen/__gen";
const CUSTOM_AXIOS_PATH = "./frontend/src/swagger-gen/axios/index.ts";
...
module.exports = SPECS.reduce(
  (acc, { fileName, baseUrl }) => ({
    ...acc,
    [fileName]: {
      input: {
